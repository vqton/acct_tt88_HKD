...
-- Chữ ký điện tờ / trạng thái phê duyệt
...
CREATE TABLE so_chi_phi (
    ...
    cp_thue_kho_bai_mat_bang DECIMAL(18,2) DEFAULT 0,
...
('MD_UPDATE', 'Cap nhat Master Data'),

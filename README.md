...
- [x] MD-04: Đối tác (Nhà cung cấp) (Domain layer completed)
- [x] MD-05: Khách hàng (Domain layer completed)
- [x] MD-06: Nhân viên (Domain layer completed)
- [x] MD-07: Tài khoản ngân hàng (Domain layer completed)
- [x] MD-08: Kỳ kế toán (Domain layer completed)
